#
#  Be sure to run `pod spec lint LYNetworkRequestKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = "网络请求库、支持自定义参数、自定义url 可以高度自定义、继承hud 和请求取消的回调"

  s.homepage     = "https://github.com/shadow-boy/LYNetworkRequestKit.git"
  ...
  s.source       = { :git => "https://github.com/shadow-boy/LYNetworkRequestKit.git", :tag => s.version.to_s }
  ...
  #  you can include multiple dependency to ensure it works.
